...
import {fetchProductsByFiltersAsync,fetchCategoriesAsync,fetchBrandsAsync, selectAllProducts,selectTotalItems ,selectCategories,selectBrands } from "../productSlice";
...
import  {ITEMS_PER_PAGE}  from "../../../app/constpage";
...
// function Pagination({ page, setPage, handlePage, totalItems = 60 }) {
//   return (
...
//             {console.log(Array.from({ length: Math.ceil(totalItems / ITEMS_PER_PAGE) }))}
