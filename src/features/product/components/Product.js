...
import {fetchAllProductsAsync ,fechProductsByFilterAsync, selectAllProducts, fechProductsBySortAsync } from "../productSlice";
...
export default function Product() {
  ...
  const handleFilter =(e,section,option)=>{
    ...
    setFilter(newFilter)
    dispatch(fechProductsByFilterAsync(newFilter))
    console.log(section.id,option.value)
  }

  const handleSort =(e,option)=>{
    // console.log(option)
    let newSort = {...sort,_sort:option.sort}
    let newOrder = {_order:option.order};
    setSort(newSort)
    dispatch(fechProductsBySortAsync(newSort,newOrder))
    console.log(newSort,newOrder)

    // setFilter(newSort)
    // dispatch(fechProductsByFilterAsync(newSort))
    // console.log({...sort,_sort:option.sort,_order:option.order})
  }
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="mx-auto max-w-2xl px-2 pt-0 py-2 sm:px-2  lg:max-w-7xl lg:px-8">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900">
                Customers also like products
              </h2>
